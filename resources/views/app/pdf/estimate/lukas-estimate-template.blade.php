            ...
            <div class="company-address-container company-address">
                 <table>
                    <tr>
                        ...
                        <td class="attribute-value"> &nbsp;{{ $estimate->customer->name }}</td>
                    </tr>
                    <tr>
                        <td class="attribute-label">Rif:</td>
                        <td class="attribute-value"> &nbsp;{{ $estimate->customer->rif }}</td>
                    </tr>
                    <tr>
                        <td class="attribute-label">Telefono:</td>
                        <td class="attribute-value"> &nbsp;{{ $estimate->customer->phone  }}</td>
                    </tr>
