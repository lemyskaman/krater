...
class Company extends Model implements HasMedia
{
    ...
    public function setupDefaultSettings()
    {
        ...
        $billingAddressFormat = '<p>{BILLING_ADDRESS_STREET_1} {BILLING_ADDRESS_STREET_2}</p><p>{BILLING_CITY}  {BILLING_STATE}  {BILLING_COUNTRY} {BILLING_ZIP_CODE} {BILLING_PHONE}</p>';
