...
class Company extends Model implements HasMedia
{
    ...
    public function setupDefaultSettings()
    {
        ...
        $billingAddressFormat = '<p>{BILLING_ADDRESS_STREET_1}</p><p>{BILLING_ADDRESS_STREET_2}</p><p>{BILLING_CITY}  {BILLING_STATE}</p><p>{BILLING_COUNTRY}  {BILLING_ZIP_CODE}</p><p>{BILLING_PHONE}</p>';
